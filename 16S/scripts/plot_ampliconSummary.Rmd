...
```{r}
plot_ordination(physeq.prune.rarefy, physeq.prune.rarefy.ps.ord, type = "samples", color = "Extraction",shape="Treatment")  + ggtitle("Bacterial Beta Diversity (PCoA) by Owner")
```
